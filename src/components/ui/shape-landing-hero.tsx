...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#B4FF00]/[0.04] via-transparent to-purple-500/[0.04] blur-3xl" />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            animate="visible"
          >
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-black uppercase tracking-tight leading-none mb-6 md:mb-8">
              <span className="bg-clip-text text-transparent bg-gradient-to-b from-white to-white/80">
                {title1}
              </span>
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#B4FF00] via-white/90 to-[#B4FF00]/70">
                {title2}
              </span>
            </h1>
          </motion.div>
          ...
          <motion.div
            ...
            animate="visible"
          >
            <a href="/waitlist" className="btn-neon text-base px-8 py-4 inline-block">
              Join the Waitlist
            </a>
          </motion.div>
        </div>
